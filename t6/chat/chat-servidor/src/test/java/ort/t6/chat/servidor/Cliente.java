...
public class Cliente extends JFrame {
	...
	public Cliente(String host) {
		...
		servidorChat = host; // establecer el servidor al que se va a conectar
								// este cliente
	...
	private void conectarAServidor() throws IOException {
		...
		cliente = new Socket(InetAddress.getByName(servidorChat), 4000);
	...
	private void obtenerFlujos() throws IOException {
		...
		salida.flush(); // vacíar búfer de salida para enviar información de
						// encabezado
